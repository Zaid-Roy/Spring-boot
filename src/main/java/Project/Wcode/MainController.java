...
public class MainController {
    ...
    public @ResponseBody Usuario getUser(@PathVariable String idUsuarios) {
        // This returns a JSON or XML with the users
        return userRepository.findById(parseInt(idUsuarios));
    }
    @PutMapping(path="/update/{idUsuarios}")
    public @ResponseBody Usuario updateUser(@PathVariable String idUsuarios,@RequestParam Usuario us){
